...
window.addEventListener("keydown", function(e){
    //e.keyCode=="39" that case that is move in right direction
...
//e.keyCode=="37" that case is move on left direction
    if(e.keyCode == "37"){
...
setInterval(function Gameover (){
    ...
    var raceCarLeft = parseInt(window.getComputedStyle(raceCar).getPropertyValue("left"));
        if((blueCarLeft === raceCarLeft) && (blueCarTop > 450) && (blueCarTop < 750)){
